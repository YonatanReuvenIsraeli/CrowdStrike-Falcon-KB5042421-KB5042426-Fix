@echo off
setlocal
title CrowdStrike Falcon KB5042421-KB5042426 Fix
echo Program Name: CrowdStrike Falcon KB5042421-KB5042426 Fix
echo Version: 1.0.0
...
:Fix
del "%DriveLetter%\Windows\System32\Drivers\C-00000291*.sys" > nul 2>&1
